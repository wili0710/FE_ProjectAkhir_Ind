...
export default connect(mapStatetoProps) (class DeployParcel extends React.Component {
    ...
    componentDidUpdate() {
        console.log(this.props.Parcel.ready_Parcel);
    };
        ...
        return (
            <section style={{positon:"absolute", background:"lightgray", margin:0, height:"100vh"}}>
                <div style={{position:"relative", display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", padding:40}}>
                    <h1 style={{textAlign:"center", letterSpacing:"3px", fontWeight:400}}> Parcels ready to <span style={{backgroundColor:"tomato", color:"white", padding:"10px 10px", letterSpacing:"2px"}}>{"<Deployed/>"}</span></h1>
                    ...
                    {
                            this.props.Parcel.ready_Parcel?
                            this.props.Parcel.ready_Parcel.map((val,index)=>{
                                return(
                                    <div key={index} style={{position:"relative", marginRight:10, background:"white", padding:20}}>
                                        ...
                                        <div>
                                            ...
                                            <div style={{display:"flex", width:"100%"}}>
                                                 <button style={{backgroundColor:"gray", color:"white", width:"100%"}} 
                                                     //    onClick={()=>this.onSendtoDatabase(index)}
                                                 >
                                                     Deploy
                                                 </button>
                                            </div>
